...
mod tests {
    ...
    fn test_bitwise_and() {
        ...
        let result = vm.run_scalar(0.0.to_fixed(), 0.0.to_fixed(), 0.0.to_fixed()).unwrap();
        assert_eq!(result.to_i32(), 8); // 12 & 10 = 8
    }
    ...
    fn test_bitwise_or() {
        ...
        let mut vm = LpsVm::new(&program, vec![], VmLimits::default()).unwrap();
        let result = vm.run_scalar(0.0.to_fixed(), 0.0.to_fixed(), 0.0.to_fixed()).unwrap();
        assert_eq!(result.to_i32(), 14); // 12 | 10 = 14
    }
    ...
    fn test_bitwise_xor() {
        ...
        let mut vm = LpsVm::new(&program, vec![], VmLimits::default()).unwrap();
        let result = vm.run_scalar(0.0.to_fixed(), 0.0.to_fixed(), 0.0.to_fixed()).unwrap();
        assert_eq!(result.to_i32(), 6); // 12 ^ 10 = 6
    }
    ...
    fn test_left_shift() {
        ...
        let mut vm = LpsVm::new(&program, vec![], VmLimits::default()).unwrap();
        let result = vm.run_scalar(0.0.to_fixed(), 0.0.to_fixed(), 0.0.to_fixed()).unwrap();
        assert_eq!(result.to_i32(), 20); // 5 << 2 = 20
    }
    ...
    fn test_right_shift() {
        ...
        let mut vm = LpsVm::new(&program, vec![], VmLimits::default()).unwrap();
        let result = vm.run_scalar(0.0.to_fixed(), 0.0.to_fixed(), 0.0.to_fixed()).unwrap();
        assert_eq!(result.to_i32(), 5); // 20 >> 2 = 5
    }
