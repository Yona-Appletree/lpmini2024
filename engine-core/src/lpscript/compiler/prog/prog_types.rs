...
use crate::lpscript::compiler::ast::{AstPool, ExprId, Program, StmtId, StmtKind};
...
impl TypeChecker {
    ...
    fn check_function_body(
        ...
        params: &[crate::lpscript::compiler::ast::Parameter],
        func_span: crate::lpscript::shared::Span,
        func_name: &str,
        pool: &mut AstPool,
        func_table: &FunctionTable,
    ) -> Result<(), TypeError> {
