...
/// the blocking API.
///
/// This buffer size is calculated for the synchronous API provided by the [RmtWs2811].
...
pub struct RmtWs2811<TX, const BUFFER_SIZE: usize>
where
...
impl<'d, TX, const BUFFER_SIZE: usize> RmtWs2811<TX, BUFFER_SIZE>
where
    TX: RawChannelAccess + TxChannelInternal + 'static,
{
...
impl<TX, const BUFFER_SIZE: usize> SmartLedsWrite for RmtWs2811<TX, BUFFER_SIZE>
where
    TX: RawChannelAccess + TxChannelInternal + 'static,
{
...
/// [RmtWs2811Async]. [buffer_size] should be used for the synchronous API.
...
pub struct RmtWs2811Async<Tx, const BUFFER_SIZE: usize>
where
    Tx: RawChannelAccess + TxChannelInternal + 'static,
{
...
impl<'d, Tx, const BUFFER_SIZE: usize> RmtWs2811Async<Tx, BUFFER_SIZE>
where
    Tx: RawChannelAccess + TxChannelInternal + 'static,
{
    /// Create a new adapter object that drives the pin using the RMT channel.
...
impl<Tx, const BUFFER_SIZE: usize> SmartLedsWriteAsync for RmtWs2811Async<Tx, BUFFER_SIZE>
where
    Tx: RawChannelAccess + TxChannelInternal + 'static,
{
    type Error = LedAdapterError;
