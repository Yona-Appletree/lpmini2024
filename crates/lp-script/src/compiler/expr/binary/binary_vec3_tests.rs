...
mod tests {
    ...
    fn test_vec3_division() -> Result<(), String> {
        ExprTest::new("vec3(12.0, 18.0, 24.0) / vec3(3.0, 6.0, 8.0)")
            .expect_opcodes(vec![
                ...
                LpsOpCode::Push(18.0.to_fixed()),
                LpsOpCode::Push(24.0.to_fixed()),
                LpsOpCode::Push(3.0.to_fixed()),
                LpsOpCode::Push(6.0.to_fixed()),
    ...
    fn test_vec3_modulo() -> Result<(), String> {
        ExprTest::new("vec3(10.0, 7.0, 15.0) % vec3(3.0, 2.0, 4.0)")
            ...
            .expect_result_vec3(Vec3::new(1.0.to_fixed(), 1.0.to_fixed(), 3.0.to_fixed()))
            .run()
    }
    ...
    // Vec3 * Int32 scalar (should promote Int32 to Fixed)
    #[test]
    fn test_vec3_int32_scalar_multiplication() -> Result<(), String> {
        ExprTest::new("vec3(1.0, 2.0, 3.0) * 2")
            .expect_result_vec3(Vec3::new(2.0.to_fixed(), 4.0.to_fixed(), 6.0.to_fixed()))
            .run()?;
    ...
    fn test_edge_cases() -> Result<(), String> {
        ...
        ExprTest::new("vec3(-1.0, -2.0, -3.0) + vec3(3.0, 4.0, 5.0)")
            .expect_result_vec3(Vec3::new(2.0.to_fixed(), 2.0.to_fixed(), 2.0.to_fixed()))
            .run()?;
