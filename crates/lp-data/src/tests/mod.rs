...
use crate::metadata::{
    ...
    RecordField, RecordType, StringUi, Vec2Ui, Vec3Ui, Vec4Ui,
};
use crate::TypeRef;
use alloc::vec::Vec;
...
fn scalar_defaults_use_textbox_ui() {
    ...
    let fixed_scalar = match fixed_ty {
        LpType::Scalar(LpScalarType::Fixed(meta)) => meta,
...
fn record_field_docs_are_preserved() {
    ...
    let record = match RECORD.ty {
        ...
        _ => panic!("expected record metadata"),
    };
