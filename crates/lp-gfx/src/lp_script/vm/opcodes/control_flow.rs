...
use crate::lp_script::vm::call_stack::CallStack;
use crate::lp_script::vm::error::LpsVmError;
use crate::lp_script::vm::local_stack::LocalStack;
use crate::lp_script::vm::lps_program::LpsProgram;
...
mod tests {
    ...
    fn test_call() {
        ...
        use crate::lp_script::vm::lps_program::{FunctionDef, LocalVarDef};
    ...
    fn test_call_invalid_function() {
        use crate::lp_script::shared::Type;
        use crate::lp_script::vm::lps_program::FunctionDef;
