...
use crate::lp_script::compiler::ast::{Expr, Program};
use crate::lp_script::LpsOpCode;
...
impl<'a> CodeGenerator<'a> {
    ...
    pub fn generate(
        expr: &Expr,
    ) -> Result<Vec<LpsOpCode>, crate::lp_script::compiler::error::CodegenError> {
    ...
    pub fn generate_with_locals(
        expr: &Expr,
        predeclared: Vec<(String, u32, crate::lp_script::shared::Type)>,
    ) -> Result<Vec<LpsOpCode>, crate::lp_script::compiler::error::CodegenError> {
    ...
    pub(crate) fn generate_program_with_functions(
        program: &Program,
        func_table: &crate::lp_script::compiler::func::FunctionTable,
    ) -> Result<
        Vec<crate::lp_script::vm::FunctionDef>,
        crate::lp_script::compiler::error::CodegenError,
    > {
