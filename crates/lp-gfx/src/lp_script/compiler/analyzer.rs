...
use crate::lp_script::compiler::ast::{Parameter, Program, Stmt, StmtKind};
use crate::lp_script::compiler::codegen::LocalAllocator;
use crate::lp_script::compiler::error::{TypeError, TypeErrorKind};
use crate::lp_script::compiler::func::{FunctionMetadata, FunctionTable, LocalVarInfo};
...
impl FunctionAnalyzer {
    ...
    pub(crate) fn analyze_program(program: &Program) -> Result<FunctionTable, TypeError> {
