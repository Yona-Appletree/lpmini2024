...
use crate::lp_script::compiler::error::{ParseError, ParseErrorKind};
use crate::lp_script::compiler::lexer::{Token, TokenKind};
...
mod tests {
    ...
    fn test_parse_simple_expression() {
        ...
        let expr = parser.parse().expect("parser should succeed");
