...
#[cfg(test)]
mod tests {
    use lp_math::dec32::{ToDec32, Vec2, Vec3, Vec4};
    ...
    fn test_simple_assignment() {
        ...
        ExprTest::new("x = 5.0")
            .local_dec32(0, "x", 0.0.to_dec32())
            .expect_ast(|b| {
                let value = b.num(5.0);
                b.assign("x", value, Type::Dec32)
            })
            .expect_result_dec32(5.0)
            .expect_local_dec32("x", 5.0)
            .run()
    ...
    fn test_chained_assignment() {
        ...
        ExprTest::new("z = y = x = 7.0")
            .local_dec32(0, "x", 0.0.to_dec32())
            .local_dec32(1, "y", 0.0.to_dec32())
            .local_dec32(2, "z", 0.0.to_dec32())
            .expect_result_dec32(7.0)
            .expect_local_dec32("x", 7.0)
            .expect_local_dec32("y", 7.0)
            .expect_local_dec32("z", 7.0)
            .run()
    ...
    fn test_assignment_in_expression() {
        ...
        ExprTest::new("(x = 3.0) + (y = 4.0)")
            ...
            .local_dec32(1, "y", 0.0.to_dec32())
            .expect_result_dec32(7.0)
            .expect_local_dec32("x", 3.0)
            .expect_local_dec32("y", 4.0)
            .run()
    ...
    fn test_vec2_assignment() {
        ...
        ExprTest::new("v = vec2(1.0, 2.0)")
            .local_vec2(0, "v", Vec2::new(0.0.to_dec32(), 0.0.to_dec32()))
            .expect_ast(|b| {
                let arg1 = b.num(1.0);
                let arg2 = b.num(2.0);
    ...
    fn test_vec3_assignment() {
        ...
        ExprTest::new("v = vec3(1.0, 2.0, 3.0)")
            .local_vec3(
                0,
                "v",
                Vec3::new(0.0.to_dec32(), 0.0.to_dec32(), 0.0.to_dec32()),
            )
    ...
    fn test_vec2_chained_assignment() {
        ...
        ExprTest::new("b = a = vec2(5.0, 6.0)")
            .local_vec2(0, "a", Vec2::new(0.0.to_dec32(), 0.0.to_dec32()))
            .local_vec2(1, "b", Vec2::new(0.0.to_dec32(), 0.0.to_dec32()))
            .expect_result_vec2(Vec2::new(5.0.to_dec32(), 6.0.to_dec32()))
            .run()
    ...
    fn test_plus_eq_assignment() {
        ...
        ExprTest::new("x += 5.0")
            .local_dec32(0, "x", 10.0.to_dec32())
            .expect_result_dec32(15.0)
            .expect_local_dec32("x", 15.0)
            .run()
    ...
    fn test_star_eq_assignment() {
        ...
        ExprTest::new("x *= 2.0")
            .local_dec32(0, "x", 5.0.to_dec32())
            .expect_result_dec32(10.0)
            .expect_local_dec32("x", 10.0)
            .run()
    ...
    fn test_compound_assignment_with_expression() {
        ...
        ExprTest::new("x += y * 2.0")
            .local_dec32(0, "x", 10.0.to_dec32())
            .local_dec32(1, "y", 5.0.to_dec32())
            .expect_result_dec32(20.0)
            .expect_local_dec32("x", 20.0)
            .run()
