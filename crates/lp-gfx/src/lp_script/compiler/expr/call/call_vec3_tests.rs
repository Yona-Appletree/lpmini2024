...
mod tests {
    ...
    fn test_cross() -> Result<(), String> {
        ExprTest::new("cross(vec3(1.0, 0.0, 0.0), vec3(0.0, 1.0, 0.0))")
            ...
            .expect_result_vec3(lp_math::dec32::Vec3::new(
                0.0.to_dec32(),
                0.0.to_dec32(),
                1.0.to_dec32(),
            ))
    ...
    fn test_perlin3() -> Result<(), String> {
        ...
        let program = crate::lp_script::parse_expr("cos(perlin3(vec3(uv * 0.3, time), 3))");
    ...
    fn test_perlin3_only_pushes_xyz() -> Result<(), String> {
        ...
        let program = crate::lp_script::parse_expr("perlin3(vec3(xNorm, yNorm, time), 3)");
